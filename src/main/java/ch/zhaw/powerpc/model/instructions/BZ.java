...
public class BZ extends AbstractInstruction {
	...
	/**
	 * Erstellt einen Sprungbefehl auf die Adresse, die in einem Register hinterlegt ist, mit der Bedingung, dass der Akku = 0 ist.
	 * 
	 * @param register
	...
	public String toString() {
		return "BZ " + this.register;
	}

	@Override
	public char getBinary() {
		return genBin("0001", reg(this.register), "10", "00000000");
	}
